...
public class Tapahtumankuuntelija implements ActionListener {
    ...
    private JButton nollaa; // reset
    private JButton undo;
    private Sovelluslogiikka sovellus; // application logic
    private Map<JButton, Komento> komennot;  // commands
    private Komento edellinen; // previous
    ...
    public Tapahtumankuuntelija(JButton plus, JButton miinus, JButton nollaa, JButton undo, JTextField tuloskentta, JTextField syotekentta) {
        ...
        komennot.put(plus, new Summa(sovellus, tuloskentta, syotekentta)); // application, result, input 
